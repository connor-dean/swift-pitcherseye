...
//        switch result {
//        case 1:
//            decrementIfAboveZero(count: &pitchCount_1)
//            print("pitchCount_1: \(pitchCount_1!)")
//        case 2:
//            decrementIfAboveZero(count: &pitchCount_2)
//        case 3:
//            decrementIfAboveZero(count: &pitchCount_3)
//        case 4:
//            decrementIfAboveZero(count: &pitchCount_4)
//        case 5:
//            decrementIfAboveZero(count: &pitchCount_5)
//        case 6:
//            decrementIfAboveZero(count: &pitchCount_6)
//        case 7:
//            decrementIfAboveZero(count: &pitchCount_7)
//        case 8:
//            decrementIfAboveZero(count: &pitchCount_8)
//        case 9:
//            decrementIfAboveZero(count: &pitchCount_9)
//        default:
//            print("Whoops, something went wrong!")
//        }
//    }
    
    func decrementIfAboveZero(count: inout Int?) {
        if count! > 0 {
            count! -= 1
        }
    }
